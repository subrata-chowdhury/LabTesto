...
const TubeIcon: React.FC<{ fill?: string, size?: number }> = ({ fill = '', size = 24 }) => (
	<svg aria-hidden="true" focusable="false" role="img" fill={fill ? fill : 'none'} preserveAspectRatio="xMidYMid meet" data-icon="Test-tube" viewBox="0 0 24 25" width={size} className="sc-f32db17d-0 sc-c1dcc9aa-0 cjEpGv hhQbhi sc-67b3f994-0 fOKaUa">
