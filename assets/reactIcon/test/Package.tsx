...
const PackageIcon: React.FC<{ fill?: string, size?: number }> = ({ fill = '', size= 24 }) => (
	<svg aria-hidden="true" focusable="false" role="img" fill={fill ? fill : 'none'} preserveAspectRatio="xMidYMid meet" data-icon="back" viewBox="0 0 22 20" width={size} className="sc-f32db17d-0 sc-c1dcc9aa-0 iymUWI hhQbhi sc-b9d72297-0 fBJtou">
