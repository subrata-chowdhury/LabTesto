...
const FoodIcon: React.FC<{ fill?: string, size?: number }> = ({ fill = '', size= 24 }) => (
	<svg aria-hidden="true" focusable="false" role="img" fill={fill ? fill : 'none'} preserveAspectRatio="xMidYMid meet" data-icon="FastingIcon" viewBox="0 0 24 24" width={size} height={size} className="sc-f32db17d-0 sc-c1dcc9aa-0 cjEpGv hhQbhi sc-64dfa9c2-0 fBrqTp">
