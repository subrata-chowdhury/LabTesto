  ...
  return (
    <section className="container mx-auto mt-8">
      ...
      >
        {tags.map((tag) => (
          <div
            className="px-4 border border-gray-300 dark:border-white/25 rounded-md col-auto p-2"
            key={tag.text}
          >
            <p>
              {tag.icon} {tag.text}
    ...
    <div className="w-full inline-block border border-gray-300 dark:border-white/20 mb-4 break-inside-avoid bg-white dark:bg-black rounded-lg text-start shadow-md shadow-primary/5">
      <div className="px-4 py-3">
        <div className="flex items-center mr-auto">
          ...
          <UserIcon
            size={45}
            className="p-2 bg-primary/20 dark:bg-white/30 text-primary dark:text-white rounded-full"
          />
          <div className="ml-2">
      ...
      <div className="relative w-full" style={{ height: testimonial.height }}>
        ...
        <div
          style={{
            // top: testimonial.top,
            background:
              "linear-gradient(transparent 10%, rgba(0, 0, 0, 0.7) 90%)",
          }}
