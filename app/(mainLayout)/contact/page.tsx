    ...
    return (
        <>
            <div className='flex flex-col relative items-center pb-12 mb-6 bg-primary/80'>
                ...
                <svg className="w-full h-20 absolute bottom-0 translate-y-1/2 text-white dark:text-white/0" viewBox="0 0 1200 40" preserveAspectRatio="none">
                    <path
            ...
            <div className='sm:w-fit mx-auto flex flex-col lg:flex-row gap-4 mb-8'>
                ...
                <div className='flex flex-col'>
                    <h2 className={"text-2xl font-bold text-primary dark:text-white mb-4"}>Find Us</h2>
