...
export default function ContactDetails({
  ...
  return (
    <div
      className={
        "grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 my-8 w-full max-w-7xl px-6 mx-auto " +
        className
      }
    >
      <div className="flex flex-col items-center shadow-md rounded-xs p-4 gap-4 bg-white dark:bg-black border-2 border-gray-300/50 dark:border-white/30">
        <div
          className={
            "p-4 bg-white rounded-full border border-gray-300/50 shadow text-black " +
            iconClassName
          }
        >
          <PhoneIcon />
