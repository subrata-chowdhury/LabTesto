...
const page = () => {
  return (
    <div className="px-5 py-6 flex flex-col gap-4 bg-gray-50 dark:bg-[#0A192F]">
      <div>
        <h1 className="text-2xl sm:text-3xl font-semibold text-center mx-auto mt-4">
...
function DetailCardToggler({
  ...
  return (
    <div
      className={
        "border-2 border-gray-300/70 bg-white dark:bg-[#172A46] dark:border-gray-500 px-4 py-2.5 rounded-md w-full animate-fadeInUpScroll " +
        className
      }
    >
      <input
      ...
      >
        {title}
        <span className="plus-icon my-auto">
          <Plus />
        </span>
        <span className="minus-icon my-auto">
          <Minus />
        </span>
      </label>
