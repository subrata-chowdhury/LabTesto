...
export default function Services() {
  ...
  return (
    <section
      ref={ref}
      className="mx-auto md:w-[95%] pt-0 sm:pt-0 md:pt-0 p-4 flex flex-col"
    >
      <h1
        className={
...
function ServiceCard({
  ...
  return (
    <div
      className={`border border-gray-300/50 group overflow-hidden relative transition-all dark:border-white/25 rounded-lg shadow dark:shadow-md dark:shadow-black px-5 py-4 bg-white dark:bg-black ${className}`}
      style={style}
    >
      ...
      <Image
        src={icon}
        alt={title}
        className="w-10 h-10 ml-2 mt-2 mb-4 mr-auto z-10 relative"
      />
      <h3 className="text-lg font-semibold mb-2 transition-all duration-300 text-primary group-hover:text-white dark:text-white z-10 relative">
        {title}
      </h3>
      <div className="text-gray-600 transition-all duration-300 group-hover:text-gray-200 dark:text-gray-300 text-sm z-10 relative">
        {details}
      </div>
    </div>
  );
  ...
  },
  {
    ...
    details: (
      <p>
        ...
        safety protocols to provide a seamless, comfortable home collection
        experience.
      </p>
    ),
  },
  {
    ...
    details: (
      <p>
        ...
        information is handled with the highest standards of medical integrity.
      </p>
    ),
  },
  {
  ...
  },
  {
    ...
    details: (
      <p>
        ...
        to your location, eliminating the need to travel or wait in queues
      </p>
    ),
  },
  {
