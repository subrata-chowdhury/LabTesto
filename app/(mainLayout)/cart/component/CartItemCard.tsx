      ...
      <div className="p-4 flex justify-between items-center">
        ...
        <div className="flex flex-col gap-2 text-sm">
          <div className="flex gap-2 justify-center items-center">
            <button
              className="text-lg py-1 px-1 rounded-md cursor-pointer dark:text-white hover:bg-gray-100 border-2 border-gray-300/60"
              disabled={item.quantity <= 1}
              onClick={async () => await onQuantityChange(item.quantity - 1)}
            >
              <Minus size={18} />
            </button>
            <input
