...
const AdminTestSelector: React.FC<SelectInstituteProps> = ({
  onSelect = () => {},
  ...
  return (
    <div className="relative flex-1">
      <input
        className={
          "px-3 py-2 bg-transparent border-black/10 dark:border-white/30 border-2 rounded outline-none w-full " +
          className
        }
        style={style}
        type="text"
