...
function Menubar() {
    ...
    return (
        <div className='relative bg-white dark:bg-black flex flex-col gap-2 z-20 px-4 py-6 shadow h-full transition-all' onMouseEnter={() => setMenubarHovered(true)} onMouseLeave={() => setMenubarHovered(false)}>
            <div className='flex flex-col gap-2 flex-1 transition-all'>
                ...
                <Menu name='Data Misses' image={form} link='/admin/datamiss' active={currentPath.includes('/admin/datamiss')} menubarHovered={menubarHovered} />
                <Menu name='Contacts' image={form} link='/admin/contacts' active={currentPath.includes('/admin/contacts')} menubarHovered={menubarHovered} />
            </div>
            <div className=''>
                <div
