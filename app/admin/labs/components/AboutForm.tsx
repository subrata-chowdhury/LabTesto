...
const AboutForm = ({
  ...
  return (
    <div className="bg-white dark:bg-black mt-4 p-8 px-10">
      ...
      <div className="pb-4 font-semibold mt-6 pt-5 border-t-2 border-gray-300/50">
        Address Information
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-4 text-sm pb-4">
        <Input
          ...
          onChange={(val) =>
            onChange({
              ...labDetails,
              location: {
                location: labDetails.location.location,
        ...
        <Input
          ...
          value={labDetails.location.location.lat.toString()}
          onChange={(val) =>
            onChange({
              ...labDetails,
              location: {
                ...labDetails.location,
                location: { ...labDetails.location.location, lat: Number(val) },
              },
            })
          }
          labelClass="font-medium"
        ...
        <Input
          ...
          value={labDetails.location.location.lang.toString()}
          onChange={(val) =>
            onChange({
              ...labDetails,
              location: {
      ...
      <RichTextEditor
        ...
        onChange={(val) => onChange({ ...labDetails, tempDescription: val })}
      />
