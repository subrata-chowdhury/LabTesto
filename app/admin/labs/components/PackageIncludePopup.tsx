...
export default function PackageIncludePopup({
  packageIncludeDetails,
  onClose = () => {},
  onSave = () => {},
}: {
  packageIncludeDetails: { test: string; packages: string[] };
  onClose?: () => void;
  onSave?: (packageIncludeDetails: {
    name?: string;
    test: string;
    packages: string[];
  }) => void;
      ...
      <div className="px-7 py-4 pb-2">
        ...
        <div className="text-sm pt-2">
          <TagInput
            ...
            onChange={(val) =>
              setPackageData((prevVal) => ({ ...prevVal, packages: val }))
            }
          />
        </div>
