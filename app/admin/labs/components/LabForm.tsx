  ...
  return (
    <div className="bg-white dark:bg-black mt-4 p-8 px-10">
      <div className="text-xl flex gap-3 items-center font-bold pb-6">
        Tests Lab Form of{" "}
        <span className="text-blue-600">{labDetails.name}</span>
      </div>
      ...
      <div className="pb-4 flex justify-between font-semibold">
        ...
        <div
          ...
          onClick={() =>
            setShowTestDetailsPopup({ index: labDetails.details?.length || 0 })
          }
        >
          <div>New Entry</div>
          <Image
        ...
        <MainTable<TestsDetails>
          config={[
            { heading: "Test", selector: "name" },
            {
              heading: "Price",
              selector: "name",
              component: ({ data }) => data.price,
            },
            {
              heading: "Offer",
              selector: "name",
              component: ({ data }) => data.offer,
            },
            {
              heading: "Actions",
