  ...
  return (
    <div className="bg-white dark:bg-black mt-4 p-8 px-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
        <div className="flex flex-col gap-1">
          <div className="font-medium flex items-center gap-2">
            ...
            <Title
              title={
                <p className="text-nowrap font-medium">Search using email</p>
              }
            >
      ...
      <div className="text-sm flex flex-col gap-1 pt-2">
        ...
        <textarea
          className="border-2 border-gray-300/50 rounded w-full h-20 p-2 outline-none"
          rows={5}
          ...
          config={[
            {
              ...
              selector: "product",
              component: ({ data }) => {
                return <div>{data.product.test.name}</div>;
              },
            },
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
        ...
        <div className="text-sm flex flex-col gap-1 pt-2">
          ...
          <div
            className="px-3 py-2 border-2 border-gray-300/50 h-fit rounded"
          ...
          >
            ...
            ,{" "}
            {
              new Date(orderDetails?.sampleTakenDateTime?.start || "")
                .toTimeString()
                .split(" ")[0]
            }
          </div>
        ...
        <div className="text-sm flex flex-col gap-1 pt-2">
          ...
          >
            ...
            ,{" "}
            {
              new Date(orderDetails?.sampleTakenDateTime?.end || "")
                .toTimeString()
                .split(" ")[0]
            }
          </div>
        ...
        <DateInput
          label="Report Deliver Start Date"
          ...
          error={error?.field === "reportDeliverStartDate" ? error.msg : ""}
        />
        <DateInput
          label="Report Deliver End Date"
          minTime={new Date(new Date().setHours(6, 0, 0))}
          maxTime={new Date(new Date().setHours(18, 0, 0))}
          ...
          labelClass="font-medium"
          containerClass="flex-1"
          error={error?.field === "reportDeliverEndDate" ? error.msg : ""}
        />
      </div>
      <div className="pb-4 flex justify-between font-semibold mt-6 pt-5 border-t-2 border-gray-300/50">
        Payment Information
      ...
      <div className="p-5 px-0 ms-auto justify-end items-end flex gap-4">
        ...
        <div
          className="bg-primary dark:bg-white/25 text-white h-10 flex justify-center items-center px-4 rounded cursor-pointer"
          onClick={async () => {
            await onSave();
          }}
        >
