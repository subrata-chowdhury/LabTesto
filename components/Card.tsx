...
function Card({ label = '', value = 0, className = '', colors = { lineColor: '#274E63', iconBgColor: 'rgba(219, 234, 254, 1)' } }: Props) {
    return (
        <div className={`inline-flex border-2 border-gray-300/50 rounded pl-4 pr-6 py-5 w-full md:w-fit h-fit gap-3 bg-white dark:bg-black dark:border-white/20 ${className}`}>
