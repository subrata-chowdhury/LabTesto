...
const Title: React.FC<Props> = ({ title, titleClass = '', containerStyle = {}, children }) => {
    ...
    return (
        <div className='relative flex flex-col items-center'>
            ...
            <div className='cursor-pointer' style={{ ...containerStyle }} onMouseEnter={() => setShowTitle(true)} onMouseLeave={() => setShowTitle(false)}>
                {children}
            </div>
        </div>
    )
