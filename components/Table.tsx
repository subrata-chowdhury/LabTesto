...
function Table<T>({ name, table, pagination, limit, onSearch, tag, dropdown, loading = false }: Props<T>) {
    return (
        <div className='border-2 border-gray-300/50 rounded-md dark:border-white/20 bg-white dark:bg-black'>
            <h3 className='p-3 border-b-2 border-gray-300/50 dark:border-white/30 text-xl font-semibold'>{name}</h3>
            ...
            <div className='flex flex-col gap-2 md:flex-row md:gap-0 justify-between items-center p-4'>
                <div className='flex gap-2 items-center'>
                    ...
                    <p className='text-sm text-gray-600 dark:text-white/65 text-nowrap'>Out of {pagination.totalPages}</p>
                </div>
